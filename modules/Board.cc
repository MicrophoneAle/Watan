...
void Board::display(std::ostream& out) const {
    ...
    // ALL ASCII OUTPUT BELOW IS PRESERVED EXACTLY
    // (no modifications)
    // ----------------------------------------------------------------------
    // ROW 0
    ...
    // And so on… (ASCII continues untouched)
    // ----------------------------------------------------------------------

    // All remaining rows preserved exactly:
    // ROW 3
    out << c(12) << "        " << v(0) << "        " << c(13) << h(18) << c(14)
        << "        " << v(4) << "        " << c(15) << h(19) << c(16)
        << "        " << v(5) << "        " << c(17) << std::endl;
    ...
    // ROW 4
    out << S1 << "  " << c(18) << h(26) << c(19) << "        " << v(6) << "        "
        << c(20) << h(27) << c(21) << "        " << v(7) << "        " << c(22)
        << h(28) << c(23) << std::endl;

    out << S1 << "  /            \\                /            \\                /            \\" << std::endl;

    out << S1 << d(29) << "       " << t(8) << "      " << d(30) << "              "
        << d(31) << "       " << t(9) << "      " << d(32) << "              "
        << d(33) << "       " << t(10) << "      " << d(34) << std::endl;

    out << S1 << "/    " << r(9) << "    \\            /    " << r(10) << "    \\            /    " << r(11) << "    \\" << std::endl;

    // (Full ASCII remains unchanged…)
